...
public class BlockHeight {
    ...
    private long head_block_version;

    public long getHead_block_version() {
        return head_block_version;
    }

    public void setHead_block_version(long head_block_version) {
        this.head_block_version = head_block_version;
    }
